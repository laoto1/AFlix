...
const INITIAL_NOVEL_SOURCES = [
    {
        id: 'metruyenchu',
        name: 'MTC',
        url: 'https://metruyenchu.com.vn',
        language: 'VI',
        icon: 'https://wsrv.nl/?url=metruyenchu.com.vn%2Fimages%2Flogo.png&cx=3&cy=35&cw=231&ch=210',
    },
];

const INITIAL_MOVIE_SOURCES = [
    {
        id: 'kkphim',
        name: 'PhimKK',
        url: 'https://kkphim.com',
        language: 'VI',
        icon: 'https://wsrv.nl/?url=kkphim.com%2Fassets%2Fimg%2Flogo-2.png&cx=26&cy=0&cw=2220&ch=2348',
    },
];
...
const Home = () => {
    ...
    useState(() => {
        ...
        if (isUnlocked) {
            if (!sources.find(s => s.id === 'nhentai')) {
